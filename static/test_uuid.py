...
class WidthSportReview(Enum):
    required_width = [182, 218, 245, 276, 299, 314, 339, 360, 386, 417, 436, 451, 505, 535, 591,
                      613, 637, 641, 677, 700, 720]
    # required_width = [168, 218, 232, 260, 284, 299, 303, 324, 349, 367, 390, 411, 439, 511, 531, 566,
    #                   612, 637, 666, 699, 709]
    # required_width = [505]
...
class PresetData(Enum):
    ...
    preset_3312 = ['fe8374ab-45b3-485d-aef0-3f5513c8695c',
                   ...
                   '32506ee7-7d97-4f7d-a25a-f77b335dae5a']
    ...
    preset_3625 = ['c2f15dd9-4d76-47e5-9d25-f7339328e5f9',
                   '12374844-108b-4ea8-88e2-2575d9b7c92f',
                   '0079147b-ec0e-471e-9a98-1dce6df800f1',
                   '8562bc91-e26e-4d83-bda9-b32489041a7d',
                   '9f3867ef-492a-4eee-82d6-a35ad5f41002',
                   '3295dc60-02e5-4d24-8197-b9be76540c8a',
                   'bb9c45f4-cf60-48ef-b8b5-995ef77919a0',
                   'e44844d4-c547-430d-aa0c-537b676288fc',
                   '8d9c679a-05c2-4502-b841-9eb9b9b735a1',
                   '0dffedcd-cf70-4699-9dc0-05e2057e0197',
                   '1da8dc14-1ae3-4f94-b08f-50d89922684d',
                   '4319e881-0f5c-472a-93ed-a04bd91059df',
                   '5e435881-9267-4ae0-affc-3f1ef9d02804',
                   'f811a4c2-6513-4dbc-9bda-75d54bf8d149',
                   '352862f0-98fb-489f-b577-216374943d0c',
                   'ed87a3af-b651-493a-aab6-ddd229f2d3f9',
                   'a7fe40a4-4bae-4c87-b7c7-757216a838a9',
                   '05630a42-70be-4526-bf97-0455eead4997',
                   '375c104a-df8a-473b-9400-46bd08a58f1c',
                   '7555ff72-104d-48c2-bc36-f8128789b814',
                   'f57cfbe2-bf18-424d-b04b-2e9331f2297a',
                   'f6d05295-f8ee-4463-9e23-65de4ff3ade8']
    preset_3626 = ['2a800c2b-59f2-446a-af24-be58515ddf37',
                   ...
                   '0dffedcd-cf70-4699-9dc0-05e2057e0197',
                   '241f3178-35a6-4790-af23-bf8c7c84d986',
                   '5dd55ef6-0778-439c-9898-2fb9d8a1209e',
                   '6d7b39fe-7807-45d0-912f-fcaeaec05846',
                   '70d03b84-56fc-485a-a659-b7890c033f89',
                   '512fc952-4405-4c2d-90f4-018be9cb344d',
                   '2874bc63-54ee-48e0-b639-36e330520fa4',
                   '6e723086-bdd1-4dff-b039-c99f3e826047',
                   '033d060c-08aa-423f-8bfc-5927828219fc',
                   'f62cef4b-e6d4-47c7-a8fd-2117e176fcde',
                   '1a4087da-e2b4-49e6-aec9-f327af0e669d']
    preset_3629 = ['5ddc6878-5233-4d14-a4f5-c9580c424502',
                   ...
                   'de0f8c63-7b78-4834-8b19-189a813d1c21',
                   '5e86f7e9-2b73-4ef7-ae5a-cdf529e5ce71',
                   '66ebf471-f230-430b-87ce-144cb76c9c07',
                   '3b9898c8-4efb-4af4-b8c6-83091985ce08',
...
class TVchannels(Enum):
    ...
    tv_channel = ['380ff414-7f87-4361-8124-dd0c73589693',
...
class Category(Enum):
    ...
    category_uuid = ['b2021d79-c529-45d6-880d-94fe8cab96d4',
                     ...
                     'b221e268-f5e5-459f-9b10-81abb7b1afd1',
                     '23a7e8e6-ccbf-47fc-98ef-231b90e13376',
                     '9e6a9903-30ec-460f-8332-8e91c3592d8d']  # без background_portrait
...
class OtherPresets(Enum):
    ...
    data_uuid = ['b08d1c98-58a4-44e6-a211-5ae7d8012b77',
                 ...
                 'f748fdd4-60cf-405b-a987-0f78bdbb81cf']
