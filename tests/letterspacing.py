...
# test_data = PresetData.preset_3312.value
# preset_id = [int(PresetData.preset_3312.name.split('_')[-1])]*len(test_data)
# data = list(tuple(zip(preset_id, test_data)))
#
...
class TestReviews:
    ...
    def test_width505_preset(self, page, image_snapshot, preset, review_uuid):
        query_tail = f"presetId={preset}&width=505&scale=2&quality=80&mediaType=webp"
        # print(maker_of_test_data())
